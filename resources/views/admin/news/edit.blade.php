...
<style>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Thay đổi Tin Tức</h3>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tabcordion">
                        ...
                        {{Form::open(array('url' => 'admin/news/edit', 'method' => 'post' ,'files'=>true)) }} 
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" name="url" value="{{$news->url}}" placeholder="Đường Dẫn URL"  @if ($errors->has('url')) autofocus @endif>
                                                       @if ($errors->has('url'))
                    ...
                    <script type="text/javascript">
                        ...
                        $("#fileinput").fileinput({
                        initialPreview: [
                                '<img src="{{asset($news->image)}}" class="file-preview-image" alt="" title="">'
                        ],
